...
<div style="margin-bottom: 10px">
  <a href="{{route('create')}}"><button type="button" class="btn btn-primary"><i class="bi bi-plus-lg"></i>&nbsp;Create</button></a>
</div>
@endif
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <span>&nbsp;</span>
                        <form>
                          <a href="{{ route('editStok', $duk->id) }}" class="btn btn-warning">Update Stok</a>
                        </form>
                        <span>&nbsp;</span>
