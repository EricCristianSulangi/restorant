              ...
              <div class="card-body">
                ...
                <form action="{{ route('update', ['id' => $produk->id]) }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="number" name="Stock" id="Stock" class="form-control" value="{{ $produk->Stock }}" disabled>
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input class="form-control" type="file" id="Image" name="Image" accept="image/*" value="{{ $produk->Image }}">
                    </div>
                  </div>
