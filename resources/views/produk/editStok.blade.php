    ...
    <section class="section">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form action="{{ route('updateStok', ['id' => $produk->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                  <div class="row mb-3">
                    <label for="Nama" class="col-sm-2 col-form-label">Nama Produk</label>
                    <div class="col-sm-10">
                      <input type="text"  name="NamaProduk" id="NamaProduk" class="form-control"  value="{{ $produk->NamaProduk }}" disabled>
                    </div>
                  </div>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="number" name="Stock" id="Stock" class="form-control" value="{{ $produk->Stock }}">
                    </div>
                  </div>
